...
function refreshTokenActionHud(preferredToken = null) {
  ...
  element.innerHTML = `<header class="bmfs-hud-drag-handle" title="Drag to move the action hub"><img src="${escape(model.actorImage)}" alt=""><strong>${escape(model.actorName)}</strong><button type="button" data-action="dice-style" title="${diceStyleTitle}"><i class="fa-solid fa-palette"></i></button><button type="button" data-action="close" title="Hide HUD"><i class="fa-solid fa-xmark"></i></button></header>
